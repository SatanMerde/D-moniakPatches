...
<p align="center">
  <b>Bibliothèque de patchs pour Morphe • Entièrement générée par IA</b><br>
  <i>A patch library for the Morphe framework • Entirely AI-generated</i>
</p>
...
> [!IMPORTANT]
> ### ⚠️ AVERTISSEMENT LÉGAL, MENTIONS IA & RESPONSABILITÉ / LEGAL & AI DISCLAIMER
>
> **🇫🇷 Français :**
> - 🤖 **Projet 100% Généré par IA :** L'entièreté absolue du code source, de l'architecture, des patchs et de la documentation de ce projet est conçue et générée par Intelligence Artificielle (IA). Des bugs, des dysfonctionnements ou des comportements inattendus sont possibles.
> - 🧪 **Statut Expérimental & Non Testé :** La majorité des patchs marqués `(Experimental)` n'ont **pas été testés sur appareils réels** et sont en cours de développement.
> - ⚠️ **Risque de Bannissement & Respect des CGU :** Toute modification d'application comporte un risque de détection, de restriction ou de bannissement de compte par les éditeurs de services en ligne. À utiliser en toute connaissance de cause et à vos propres risques.
> - ⚖️ **Aucune Responsabilité & But Éducatif :** Ce projet est distribué **exclusivement à des fins éducatives et de recherche** en sécurité logicielle. L'auteur et les contributeurs déclinent toute responsabilité en cas de mauvaise utilisation, de sanction ou de perte de données.
> - 🐛 **Signalement de bugs :** Si un patch ne fonctionne pas ou fait planter une application, merci d'ouvrir un ticket sur [GitHub Issues](https://github.com/SatanMerde/D-moniakPatches/issues/new?template=bug_report.yml) pour nous aider à le corriger.
>
> <br>
>
> **🇬🇧 English :**
> - 🤖 **100% AI-Generated Project:** The entirety of the source code, architecture, bytecode patches, and documentation in this repository is designed and generated by Artificial Intelligence (AI). Bugs, unexpected behaviors, or errors may occur.
> - 🧪 **Experimental & Untested Status:** Most patches marked `(Experimental)` have **not been tested on real physical devices** and remain experimental.
> - ⚠️ **Ban Risk & Terms of Service:** Modifying third-party applications may violate terms of service and lead to account penalties, restrictions, or bans. Use strictly at your own risk.
> - ⚖️ **No Liability & Educational Purpose:** This repository is provided **strictly for educational and software security research purposes**. The author and contributors accept no responsibility for misuse, data loss, or account sanctions.
> - 🐛 **Bug Reports:** If a patch crashes or fails to work, please open a ticket on [GitHub Issues](https://github.com/SatanMerde/D-moniakPatches/issues/new?template=bug_report.yml) so it can be investigated and resolved.
