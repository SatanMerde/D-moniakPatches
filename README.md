...
> [!IMPORTANT]
> ### ⚠️ AVERTISSEMENT, PRÉVENTION & IA / DISCLAIMER & SAFETY NOTICE
>
> **🇫🇷 Français :**
> - 🤖 **Projet généré par Intelligence Artificielle (IA) :** L'intégralité du code et des patchs de ce dépôt a été conçue et rédigée par une IA. Des erreurs, bugs ou comportements inattendus peuvent survenir.
> - 🧪 **Statut Expérimental :** Les patchs marqués `(Experimental)` n'ont **pas été testés sur appareils réels** et sont en cours de développement.
...
> - ⚖️ **Responsabilité :** Ce projet est distribué exclusivement à des fins éducatives et de recherche. Vous êtes seul responsable de son utilisation.
...
>
> **🇬🇧 English :**
> - 🤖 **AI-Generated Project:** All code, architecture, and patches were entirely created by AI. Bugs or unexpected behaviors may occur.
