...
// ============================================================================
// 5. Google Play Billing Client (In-App Purchases / Free Shopping)
// ============================================================================

object BillingClientLaunchBillingFlowFingerprint : Fingerprint(
...
object BillingClientLaunchBillingFlowInterfaceFingerprint : Fingerprint(
    name = "launchBillingFlow",
    returnType = "Lcom/android/billingclient/api/BillingResult;",
    parameters = listOf("Landroid/app/Activity;", "Lcom/android/billingclient/api/BillingFlowParams;"),
)

object BillingClientIsReadyFingerprint : Fingerprint(
    definingClass = "Lcom/android/billingclient/api/BillingClientImpl;",
    name = "isReady",
    returnType = "Z",
    parameters = emptyList(),
...
object BillingClientConsumeAsyncFingerprint : Fingerprint(
    name = "consumeAsync",
    returnType = "V",
    parameters = listOf("Lcom/android/billingclient/api/ConsumeParams;", "Lcom/android/billingclient/api/ConsumeResponseListener;"),
)

object BillingClientAcknowledgePurchaseFingerprint : Fingerprint(
    name = "acknowledgePurchase",
    returnType = "V",
    parameters = listOf("Lcom/android/billingclient/api/AcknowledgePurchaseParams;", "Lcom/android/billingclient/api/AcknowledgePurchaseResponseListener;"),
)

object BillingSecurityVerifyPurchaseFingerprint : Fingerprint(
    name = "verifyPurchase",
    returnType = "Z",
    parameters = listOf("Ljava/lang/String;", "Ljava/lang/String;", "Ljava/lang/String;"),
)

object UnityPurchasingGooglePlayPurchaseFingerprint : Fingerprint(
    definingClass = "Lcom/unity/purchasing/googleplay/GooglePlayPurchasing;",
    name = "purchase",
)

object UnityPurchasingGooglePlayOnPurchasesUpdatedFingerprint : Fingerprint(
    definingClass = "Lcom/unity/purchasing/googleplay/GooglePlayPurchasing;",
